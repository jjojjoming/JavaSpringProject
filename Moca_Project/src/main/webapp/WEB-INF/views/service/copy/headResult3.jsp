...
<%--                    </c:forEach>--%>
                    <div class="output_head">
                        <textarea class="output_textarea" onkeydown="resize(this)" onkeyup="resize(this)" id="choice_sentence1">${headcopyList[0].sentence}</textarea>
                        <button class="like" id="fun1">
                            <i class="fas fa-heart" aria-hidden="true"></i>
                        </button>
                    </div>
                    <div class="output_head">
                        <textarea class="output_textarea" onkeydown="resize(this)" onkeyup="resize(this)" id="choice_sentence2">${headcopyList[1].sentence}</textarea>
                        <button class="like" id="fun2">
                            <i class="fas fa-heart" aria-hidden="true"></i>
                        </button>
                    </div>
                    <div class="output_head">
                        <textarea class="output_textarea" onkeydown="resize(this)" onkeyup="resize(this)" id="choice_sentence3">${headcopyList[2].sentence}</textarea>
...
$(document).ready(function (){
    ...
    $("#fun1").click(function (){
        ...
        $.ajax({
            type:"post",
            url:"/service/copy/like?sentence="+$("#choice_sentence1").val()+"&type_id=7&user_id="+${user.id}
    ...
    $("#fun2").click(function (){
        ...
        $.ajax({
            type:"post",
            url:"/service/copy/like?sentence="+$("#choice_sentence2").val()+"&type_id=7&user_id="+${user.id}
        }).done(function(){ //.done : success와 동일
    ...
    $("#fun3").click(function (){
        ...
        $.ajax({
            type:"post",
            url:"/service/copy/like?sentence="+$("#choice_sentence3").val()+"&type_id=7&user_id="+${user.id}
        }).done(function(){ //.done : success와 동일
