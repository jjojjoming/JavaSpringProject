...
<div class="copy_container">
    <div class="copy_title">브랜드 헤드카피 만들기</div>
    <div class="copy_content">
    <form action="/service/copy/head/input/loading" method="get">
        <div class="copy_user-details">
            <div class="copy_input-box">
                <span class="copy_details">회사 / 제품 / 서비스명</span>
                <input type="text" name="brand_name" placeholder="입력하세요" required>
            </div>
            <div class="copy_input-box">
                <span class="copy_details">설명</span>
                <textarea class="copy_description" name="brand_description" placeholder="회사에 대한 간단한 설명을 남겨주세요."></textarea>
            </div>
            <div class="copy_input-box">
            ...
            <div class="copy_input-box">
                ...
                <input type="text" name="brand_main_key" placeholder="예) 자동차, 맛집, 학원 등" required>
            </div>
            <div class="copy_input-box">
                <span class="copy_details">서브 키워드 1</span>
                <input type="text" name="brand_sub_key1" placeholder="예) 식당, 교육, 컨설팅 등" required>
            </div>
            <div class="copy_input-box">
                <span class="copy_details">서브 키워드 2</span>
                <input type="text" name="brand_sub_key2" placeholder="예) 여행, 화장품, 호텔 등" required>
            </div>
        </div>
