...
<%-- <c:url var='root' value="/"/> sessionid가 주소로 붙어서 url출력 --%>
	...
	<div class="collapse navbar-collapse" id="navMenu">
		...
		<ul class="navbar-nav ml-auto">
			...
			<c:when test="${loginUserBean.userLogin == true }">
				...
				<li class="nav-item"><a href="${root }user/modify_user"
					class="nav-link">정보수정</a>
				</li>
				
				<li class="nav-item"><a href="${root}pay/mypay" class="nav-link">결재</a>
				</li>
