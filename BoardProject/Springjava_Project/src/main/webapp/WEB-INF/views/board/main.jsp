...
<title>Spring Java Project</title>
			...
			<div class="card-body">
					...
					<tbody>
						<c:forEach var='obj' items="${ contentList }">
							<tr>
								...
								<td><a href='${ root }board/read?content_idx=${ obj.content_idx }&board_info_idx=${ board_info_idx }&page=${page}'>${ obj.content_subject }</a></td>
				...
				<div class="d-none d-md-block">
					<ul class="pagination justify-content-center">
						<!-- 이전페이지로 이동하려는게 1이하이면disabled 비활성화 -->
						<c:choose>
							...
							<c:otherwise>
								<li class="page-item">
									<!--pageBean.prevPage : 백단에서 -1 구현해둔 상태--> <a
